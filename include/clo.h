...
std::string input;
std::string statics;
std::string supermaximals;
std::string tree;
int treeflag;
std::string treeprofile;
int treeprofileflag;
}; // end options struct
...
size_type input;
size_type statics;
size_type supermaximals;
size_type tree;
size_type treeflag;
size_type treeprofile;
size_type treeprofileflag;
    ...
    **/
	...
	enum options_enum {
		...
		option_format,
		option_statics,
		option_supermaximals,
		option_tree,
		option_treeprofile,
		option_treeflag,
		option_treeprofileflag,
		option_graph,
		option_debug,
		option_coverage,
		option_fullstat
